...
import me.cdh.CatManager.changeAction
    ...
    init {
        ...
        val mouseAdapter = object : MouseAdapter() {
            ...
            override fun mouseDragged(e: MouseEvent) {
                ...
                if (changeAction(Behave.RISING)) CatManager.frameNum = 0
            }

            override fun mouseReleased(e: MouseEvent) {
                if (CatManager.currentAction == Behave.RISING) {
                    changeAction(Behave.LAYING)
                    CatManager.frameNum = 0
                }
            }

            override fun mouseClicked(e: MouseEvent) {
                CatManager.bubbleState = BubbleState.HEART
                CatManager.bubbleFrame = 0
            }
        }
